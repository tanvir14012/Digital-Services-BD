...
namespace Digital_Services_BD.Utilities
{
    public class MultilanguageIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = nameof(RecoveryCodeRedemptionFailed), Description = _localizer["Recovery code should be redeemed."] };
        }
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
        {
            return new IdentityError { Code = nameof(PasswordRequiresUniqueChars), Description = _localizer["Passwords must have at least {0} unique characters.", uniqueChars] };
        }
    }
}
