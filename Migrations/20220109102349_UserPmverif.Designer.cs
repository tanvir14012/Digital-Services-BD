...
namespace Digital_Services_BD.Migrations
{
    ...
    [Migration("20220109102349_UserPmverif")]
    partial class UserPmverif
    {
            ...
            modelBuilder.Entity("Digital_Services_BD.Models.EncryptionKey", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Key = "d+QJ2eerbZmLOD1YZPRNi6cOC3oaidxsFjap2SKFfcUNyTSl1oKYB+aBY9OeuqXa",
                            LastUpdated = new DateTime(2022, 1, 9, 10, 23, 49, 331, DateTimeKind.Utc).AddTicks(3293)
                        });
                });
