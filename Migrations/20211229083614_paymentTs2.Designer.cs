...
namespace Digital_Services_BD.Migrations
{
    ...
    [Migration("20211229083614_paymentTs2")]
    partial class paymentTs2
    {
            ...
            modelBuilder.Entity("Digital_Services_BD.Models.EncryptionKey", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Key = "Byu6TcLDWT3ays+YJ7iL3126gHkK4KHon5f7x6bK22x+S3gD5uAIq+UKfSb0/bP4",
                            LastUpdated = new DateTime(2021, 12, 29, 8, 36, 14, 126, DateTimeKind.Utc).AddTicks(427)
                        });
                });
            ...
            modelBuilder.Entity("Digital_Services_BD.Models.ProductStock", b =>
                {
                    b.HasOne("Digital_Services_BD.Models.OrderItem", "OrderItem")
                        ...
                        .HasForeignKey("Digital_Services_BD.Models.ProductStock", "OrderItemId")
                        .HasConstraintName("FK_ProductStock_OrderItemId");
