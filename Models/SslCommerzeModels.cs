...
namespace Digital_Services_BD.Models
{
    public class Trasnaction
    {
        ...
        public Trasnaction(decimal totalAmount, string transactionID, string successUrl, string failUrl, string cancelUrl,
            EmiTransaction emiTransaction, SslCustomer customer,string storeUrl, string storeId, string storePass)
        {
            ...
            this.SslCustomer = customer ?? throw new ArgumentNullException(nameof(customer));
        ...
        public SslCustomer SslCustomer { get; private set; }
    ...
    public class SslCustomer
    {
        public SslCustomer(string name, string email, string phone)
        {
    ...
    public class CartInformation
    {
        ...
        {
            SslCartItems = new List<SslCartItem>();
        }

        public ICollection<SslCartItem> SslCartItems { get; set; }
    ...
    public class SslCartItem
    {
        public SslCartItem(string product, decimal amount)
        {
